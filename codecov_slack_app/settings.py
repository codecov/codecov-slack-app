...
CSP_STYLE_SRC = ("'self'", "'sha256-D+iNaQqqton9W916d40qgS+X8nOP2VHjDjx0w3cEujI='","'sha256-+AlBw0A7j4zf7h9B5zjFUG9WQsg25R3V/jal835TrYk='", "'sha256-G9kZzyN24irmY+hg/rWbW9P5DYILFdr63wXKRPMJlCc='")
...
# Define the absolute filesystem path to the directory where your static files will be collected.
